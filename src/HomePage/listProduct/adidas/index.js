...
function Adidas () {
    ...
    return (
        <div className="row" id="adidas" style={{justifyContent: 'center', marginTop: '50px'}}>
            <div className="col-lg-10" id="adidas__banner" style={{cursor: 'pointer'}}>
                <RenderBanner title='adidas'/>
            </div>
            <div className="col-lg-10" style={{marginTop: '50px'}}>
                <div className="row row-sneakers row-sneakers-adidas">
                    <RenderProductsBrand title='adidas' products={products} />
                </div>
