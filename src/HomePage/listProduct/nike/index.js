...
function Nike () {
    ...
    return (
        <div className="row" id="nike" style={{justifyContent: 'center', marginTop: '50px'}}>
            <div className="col-lg-10" id="nike__banner" style={{cursor: 'pointer'}}>
                <RenderBanner title='nike'/>
            </div>
            <div className="col-lg-10" style={{marginTop: '50px'}}>
                <div className="row row-sneakers row-sneakers-nike">
                    <RenderProductsBrand title='nike' products={products} />
                </div>
