...
function Jordan () {
    ...
    return (
        <div className="row" id="jordan" style={{justifyContent: 'center', marginTop: '50px'}}>
            <div className="col-lg-10" id="jordan__banner" style={{cursor: 'pointer'}}>
                <RenderBanner title='jordan'/>
            </div>
            <div className="col-lg-10" style={{marginTop: '50px'}}>
                <div className="row row-sneakers row-sneakers-jordan">
                    <RenderProductsBrand title='jordan' products={products} />
                </div>
