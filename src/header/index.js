            ...
            <div className="row">
                <div className={clsx('navtotal', 'col-lg-12')} id={clsx(styles.nav)}>
                    <ul className="nav">
                        ...
                        <li className={clsx(styles.nav__navitem, 'nav__navitem')}><Link to='/giamgia'><i className='bx bx-money-withdraw'></i> GIẢM GIÁ</Link></li>
                        <li className={clsx(styles.nav__navitem, 'nav__navitem')}><a href="#lienhe"><i className='bx bx-phone'></i> LIÊN HỆ</a></li>
                        <li className={clsx(styles.nav__navitem, 'nav__navitem')}><i className="fa-solid fa-cart-shopping"></i> GIỎ HÀNG</li>
                ...
                <nav className="nav-mobile" id="nav-mobile">
                    ...
                    <li className="navbar-item"><Link to='/'><i className='bx bx-home'></i> TRANG CHỦ</Link></li>
                    <li className="navbar-item"><a href=""><i className='bx bx-duplicate'></i> DANH MỤC SẢN PHẨM</a></li>
                    ...
                    <li className="navbar-item"><a href=""><i className='bx bx-money-withdraw'></i> GIẢM GIÁ</a></li>
                    <li className="navbar-item"><a href="#lienhe"><i className='bx bx-phone'></i> LIÊN HỆ</a></li>
                </nav>
            </div>
        </div>
    )
